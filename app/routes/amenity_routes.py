...
api = Api(app, version='1.0', title='Amenity API', description='Endpoints for Amenity CRUD operations')
...
def serialize_amenity(amenity):
    """
    Convertit les objets datetime en chaîne dans les données d'agrément.
    """
    return {
        'id': amenity['id'],
        'name': amenity['name'],
...
class AmenityList(Resource):
    """
    Classe AmentyList qui hérite Ressource.
    """

    @amenity_ns.marshal_list_with(amenity_model)
    def get(self):
        """
        Récupère toutes les aménités.
        """
...
class AmenityDetail(Resource):
    """
    Classe AmentyDetail qui hérite Ressource.
    """
    ...
    def get(self, amenity_id):
        """
        Récupère les détails d'une aménité spécifique.
        """
    ...
    def put(self, amenity_id):
        """
        Met à jour une aménité existante.
        """
    ...
    def delete(self, amenity_id):
        """
        Supprime une aménité spécifique.
        """
